...
class LoginScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isMobileMode =
        enforceMobileMode || !AIChatChatThemes.isColumnMode(context);
    if (isMobileMode) {
      return Scaffold(
        ...
        child: Row(
          ...
          children: [
            TextButton(
              ...
              child: Text('Website', style: shadowTextStyle),
            ),
            TextButton(
              onPressed: () => launchUrlString(AppConfig.supportUrl),
              child: Text('Support URL', style: shadowTextStyle),
            ),
            TextButton(
              onPressed: () => launchUrlString(AppConfig.privacyUrl),
              child: Text('Privacy', style: shadowTextStyle),
            ),
            TextButton(
              onPressed: () {},
              child: Text('About', style: shadowTextStyle),
            ),
          ],
        ),
      ),
