...
import 'package:ai_chat_chat_client/services/extensions/date_time_extension.dart';
import 'package:ai_chat_chat_client/services/matrix/room_status_extension.dart';
...
import 'package:ai_chat_chat_client/views/widgets/hover_builder.dart';
...
class ChatListItem extends StatelessWidget {
  ...
  final void Function(BuildContext contex)? onLongPress;
  ...
  Future<bool> archiveAction(BuildContext context) async {
    ...
    final confirmed = await showOkCancelAlertDialog(
      ...
      okLabel: 'Leave',
      cancelLabel: 'Cancel',
      message: 'This chat will be moved to the archive.',
      isDestructive: true,
    );
  ...
  Widget build(BuildContext context) {
    ...
    final typingText = room.getTypingText(context);
                                        ...
                                        child: AnimatedScale(
                                          duration:
                                              AIChatChatThemes
                                                  .animationDuration,
                                          curve:
                                              AIChatChatThemes.animationCurve,
                          ...
                          Expanded(
                            child:
                                room.isSpace &&
                                    ...
                                    ? Text(
                                      '${room.spaceChildren.length} chats and ${(room.summary.mJoinedMemberCount ?? 1)} participants',
                                      style: TextStyle(
                                        color: theme.colorScheme.outline,
                                      ),
                                    )
                                    ...
                                    : FutureBuilder(
                                      ...
                                      future:
                                          needLastEventSender
                                              ? Future.value(lastEvent.calcUnlocalizedBody()) : null,
                                      initialData: lastEvent?.calcUnlocalizedBody(),
                                      builder:
